        ...
        <div className="sm:pt-4 pb-12 px-2 sm:px-8 grid lg:grid-cols-2 gap-12">
          <div className="mx-auto py-8 px-6 sm:px-10 max-w-lg w-full bg-white rounded-md border border-gray-200 shadow-xl">
            ...
            <Link href={eventLinks.fall}>
              <a className="mt-5 mx-auto py-1.5 px-4 max-w-xs w-full sm:w-40 flex justify-center items-center bg-gray-900 border border-black text-gray-100 rounded-md shadow-sm hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus:ring-offset-2 focus:ring-sky-600">
                Event page
              </a>
            </Link>
          </div>
