export function html({ url }: Record<'url', string>) {
  ...
  <html lang="en">
    <head>
      <title>3D Mushing Events Dashboard Sign-in Link</title>
              ...
              <tr>
                <td style="padding: 0 64px" class="mobile-padding">
                  ...
                  >
                    <!-- Logo -->
                    <tr>
                      <td align="center" style="padding: 48px 0 8px">
                        <img
                          src="https://res.cloudinary.com/dra3wumrv/image/upload/v1646795154/3d-mushing-events/logo-combined.png"
                          alt="3D Mushing Events"
                          width="144"
                    ...
                    <!-- Email Title -->
                    <tr>
                      <td style="padding: 20px 0 16px; line-height: 1">
                        <h1
                          style="
                            margin: 0;
                            padding: 0;
                          ...
                          <tr>
                            ...
                            >
                              <p style="margin: 0 auto; padding: 0; max-width: 320px;">
                                Here is the sign-in link that you requested for the 3D Mushing Events Dashboard.
                              </p>
                            </td>
                          </tr>
                        </table>
