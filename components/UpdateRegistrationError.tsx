  ...
  return (
    <div className="px-6 absolute top-0 left-0 w-full h-screen flex justify-center items-center bg-black/70">
      ...
      >
        ...
        <p className="mt-2 text-gray-700 xxs:w-72 text-center">
        ...
        <button
          ...
          className="mt-4 py-1.5 px-6 flex justify-center items-center text-sm sm:text-base bg-gray-900 border border-black text-gray-100 rounded-md shadow-sm hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus:ring-offset-2 focus:ring-sky-600"
        >
