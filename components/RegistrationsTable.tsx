    ...
    <>
      <div className="relative lg:static px-3">
        ...
        <div className="mt-14 lg:mt-10 mb-1 w-full shadow rounded-md border border-gray-200">
          <div className="py-6 px-5 flex flex-col md:flex-row lg:flex-col xl:flex-row justify-between gap-x-4 xl:gap-x-6 bg-gray-50 rounded-t-md border-b border-gray-200">
        ...
        <div className="mt-1 mb-2 py-5">
          <p className="text-sm text-gray-700">
            Showing {registrations.length > 0 ? '1' : '0'} to{' '}
            {registrations.length} of {registrations.length} results
          </p>
        </div>
      </div>
      {csvError && (
